<?php
    ...
    $fname = "";
    $lname = "";
    $query = "SELECT issued_books.book_name, issued_books.book_author, issued_books.book_no, users.first_name, users.last_name 
    FROM issued_books 
    RIGHT JOIN users ON issued_books.student_id = users.id 
    WHERE issued_books.status = 1 OR issued_books.status = 0
    ORDER BY users.id";
