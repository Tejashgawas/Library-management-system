...
<body>
       ...
       <form action="" method="post">
           ...
           <label for="category">Student ID:</label>
           <input type="text" id="book_category" name="student_id" required><br>
       
           <label for="bookPrice">Issue Date:</label>
           <input type="date" id="book_price" name="issue_date"  required><br>
       
           <button type='submit' name="issue_book" class='add' onclick='alertMsg()'>Issue book</button>
...
<?php
	if(isset($_POST['issue_book']))
	{
        ...
        echo '<script type="text/javascript">window.location.href = "issue_book.php";</script>';
            exit();
